...
<div class="row layout-top-spacing">
    <div class="col-xl-12 col-lg-12 col-12 mb-5">
        <nav class="breadcrumb-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><span>PPDB</span></li>
            </ol>
        </nav>
    </div>
    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
        ...
        @endif
        <form action="{{ route('update-ppdb') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-4">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <hr>
                                    <img src="{{ asset('brosur.svg')}}" style="width: 290px;" class="img-fluid mb-2" alt="">
                                    <input type="text" class="form-control" value="{{$data->brosur}}" name="default_brosur" readonly>
                                    <input type="file" class="form-control" value="{{$data->brosur}}" name="brosur">
                                    @error('brosur')
                                    <br>
                                    <div class="text-danger mt-1">File tidak sesuai dengan ketentuan</div>
                                    @enderror
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <span class="text-danger">* batas ukuran 2mb</span>
                                    <hr>
                                    <img src="{{ asset('formulir.svg')}}" style="width: 250px;" class="img-fluid mb-2" alt="">
                                    <input type="text" class="form-control" value="{{$data->formulir}}" name="default_formulir" readonly>
                                    <input type="file" class="form-control" value="{{$data->formulir}}" name="formulir">
                                    @error('formulir')
                                    <br>
                                    <div class="text-danger mt-1">File tidak sesuai dengan ketentuan</div>
                                    @enderror
