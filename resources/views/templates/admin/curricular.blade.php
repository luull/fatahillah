        ...
        <div class="widget-content widget-content-area py-4 px-4 br-6">
           <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <hr>
                    <form action="{{ route('upload-file-curricular') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            <div class="row">
                                <div class="col-md-12">
                                    <label>Upload</label>
...
<script type="text/javascript">
    CKEDITOR.replace('body', {
        ...
        filebrowserBrowseUrl: "{{asset('/admin/file_browse_curricular?path=upload/curricular')}}",
